    ...
    if (!todoList) {
      ...
      if (!errors.isEmpty()) {
        ...
        res.render("list", {
          flash: req.flash(),
          todoList: todoList,
          todos: sortTodos(req.session.todoLists),
...
// render todo list destory page

app.get("/lists/:todoListId/destroy", (req, res, next) => {
  let todoListId = req.params.todoListId;
  let todoLists = req.session.todoLists;
